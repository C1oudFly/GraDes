...
<script type="text/javascript">
		...
		var myChart;
		var option;		
		myChart = echarts.init(document.getElementById('mainBar'),'light');
		...
		function test(sdate){
			...
			$.ajax({url:"/GraDes/browser/browsersessionList.do",data : {sdate : sdate},type:"GET",success:function(msg){
